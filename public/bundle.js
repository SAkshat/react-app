...
/***/ function(module, exports, __webpack_require__) {
	...
	var _evernote = __webpack_require__(/*! ./evernote.jsx */ 168);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_evernote2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sidebar = __webpack_require__(/*! ./sidebar.jsx */ 169);
	
	var _sidebar2 = _interopRequireDefault(_sidebar);
	
	var _notebooks = __webpack_require__(/*! ./notebooks.jsx */ 170);
	
	var _notebooks2 = _interopRequireDefault(_notebooks);
	
	var _notes = __webpack_require__(/*! ./notes.jsx */ 172);
	
	var _notes2 = _interopRequireDefault(_notes);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var Evernote = _react2.default.createClass({
	  ...
	  changeViewTo: function changeViewTo(view_for) {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_sidebar2.default, { changeViewTo: this.changeViewTo })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'col-md-10' },
	          _react2.default.createElement(
	            ...
	            this.state.currently_viewing == 'notes' ? _react2.default.createElement(_notes2.default, { data: this.state.notebooks, createNote: this.createNote }) : _react2.default.createElement(_notebooks2.default, { data: this.state.notebooks, createNotebook: this.createNotebook })
	          )
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Notebooks = _react2.default.createClass({
	  ...
	  getNotebookName: function getNotebookName(e) {
	    this.setState({ get_notebook_name: true });
	  },
	
	  createNotebook: function createNotebook(e) {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'row notebook-navbar' },
	        this.state.get_notebook_name ? _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement('input', { value: this.state.notebook_name, name: 'notebook_name', placeholder: 'Enter name', onChange: this.handleChange }),
	          '   ',
	          _react2.default.createElement('input', { type: 'submit', onClick: this.createNotebook, value: 'Create Notebook' })
	        ) : _react2.default.createElement(
	          'button',
	          { className: 'btn add-btn', onClick: this.getNotebookName },
	          ' Add Notebook '
	        )
	      ),
	      _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _select_box = __webpack_require__(/*! ./common_components/select_box.jsx */ 173);
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { className: 'row white' },
	          'New Note for ',
	          _react2.default.createElement(_select_box2.default, { className: 'select-list', name: 'notebooks', onValueChange: this.handleSelectBoxChange, defaultValue: 0, rows: this.props.data.map(function (notebook, index) {
...
/* 173 */
/*!*********************************************************!*\
  !*** ./src/client/app/common_components/select_box.jsx ***!
  \*********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectBox = _react2.default.createClass({
	  ...
	  renderOptions: function renderOptions() {
	    ...
	    return this.props.rows.map(function (row) {
	      return _react2.default.createElement(
	        'option',
	        { value: row[0], name: row[0], key: row[0] },
	        row[1]
	      );
	    });
	  },
	  ...
	  renderBlank: function renderBlank() {
	    return _react2.default.createElement(
	      'option',
	      { value: '', name: this.props.blankValue, key: '' },
	      this.props.blankName
	    );
	  },
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'select',
	        { className: this.props.className, name: this.props.name, id: this.props.id, onChange: this.changeValue, defaultValue: this.state.value },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _decorators = __webpack_require__(/*! ./utils/decorators.jsx */ 175);
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'span',
	          { className: 'font-size14' },
	          (0, _decorators2.default)(this.props.data.text)
	        )
	      )
	    );
	  }
